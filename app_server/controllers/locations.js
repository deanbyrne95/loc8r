...
const showError = (req, res, status) => {
    ...
    if (status === 404) {
        ...
        content =
            'Something, somewhere, sometime, has gone a little bit wrong!';
    }
    res.status(status);
...
const renderHomepage = (req, res, responseBody) => {
    ...
    res.render('locations-list', {
        ...
        sidebar:
            "Looking for Wi-Fi and a seat? Loc8r helps you find places to work when out and about. Perhaps with coffee, cake or a pint? Let Loc8r help you find the place you're looking for.",
        pageHeader: {
            title: 'Loc8r',
...
const renderDetailPage = function (req, res, location) {
    res.render('location-info', {
        ...
        sidebar: {
            context:
                'is on Loc8r because it has accessible Wi-Fi and space to sit down with your laptop and get some work done.',
            callToAction:
